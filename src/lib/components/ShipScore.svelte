...
<button class="relative" on:click={() => showScore = !showScore}>
  ...
  {#if showScore}
    <div class="absolute inset-x-0 p-4 font-mono text-6xl font-black rounded-lg shadow-2xl bg-gradient-to-br from-yellow-200 to-yellow-400 -rotate-3 top-8 text-gray-950" in:scale={{opacity: 0, start: 4}}>
